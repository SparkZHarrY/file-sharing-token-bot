...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7219119674:AAHSYUOr6cteWPYlpQ2FRH0Qdnuda4xcIaw")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002226605455"))
...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/links_tutorials_x/4") # shareus ka tut_vid he 
